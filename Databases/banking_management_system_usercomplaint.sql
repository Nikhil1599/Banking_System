...
CREATE TABLE `usercomplaint` (
  ...
  `AcNumber` int DEFAULT NULL,
  `AcName` varchar(45) DEFAULT NULL,
  `Status` varchar(45) DEFAULT 'Active',
  `Subject` varchar(45) DEFAULT NULL,
  `Complaint` varchar(300) DEFAULT NULL,
  `dateOfComplaint` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`cid`),
  KEY `acNumber_idx` (`AcNumber`),
  CONSTRAINT `acNumber` FOREIGN KEY (`AcNumber`) REFERENCES `customer` (`AccNumber`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `usercomplaint` VALUES (5,75364137,86009444,'Smriti D Singh','Completed','Nothing','Nothing','04/12/2021');
