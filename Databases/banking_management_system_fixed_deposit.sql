...
CREATE TABLE `fixed_deposit` (
  ...
  `dateOfInvest` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`Sr no`),
  KEY `acount_idx` (`AccNo`),
  CONSTRAINT `acount` FOREIGN KEY (`AccNo`) REFERENCES `customer` (`AccNumber`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `fixed_deposit` VALUES (9,60780743,86009444,500,'6 Month','04/06/2022','04/12/2021'),(10,11817502,86009444,20000,'5 Years','04/12/2026','04/12/2021');
