...
CREATE TABLE `chequebook` (
  ...
  `chequeStatus` varchar(45) DEFAULT 'Active',
  `chqLeaf` int DEFAULT '75',
  `dateOfJoining` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`Sr no`),
  KEY `account name_idx` (`AccNo`),
  CONSTRAINT `account name` FOREIGN KEY (`AccNo`) REFERENCES `customer` (`AccNumber`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `chequebook` VALUES (11,86009444,344460,'Active',75,'04/12/2021'),(12,86009444,81391541,'Active',35,'04/12/2021');
